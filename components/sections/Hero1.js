                    ...
                    <div className="row g-4 align-items-center">
                        <div className="col-lg-8">
                            <div className="hero-content">
                                <h6 className="wow fadeInUp" data-wow-delay=".2s">adasd it SOULTION Provider</h6>
                                <h1 className="wow fadeInUp" data-wow-delay=".4s">
                                    Let’s Build Your Digital Future Together
                                </h1>
                                <p className="wow fadeInUp" data-wow-delay=".6s">
                                    sdsddasdasdasda adipiscing elit aenean scelerisque at augue vitae consequat <br /> quisque eget congue velit in cursus leo sed sodales est eget turpis.
                                </p>
